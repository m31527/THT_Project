...
public final class _11_005f1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	int active_kind_id=request.getParameter("active_kind_id")==null?11:Integer.parseInt(request.getParameter("active_kind_id"));
...
for(int i=1;i<=pages;i++){
      ...
      out.write("<table class=\"table_sytle\" border=\"1\">\n");
      ...
      out.write("\t\t\t<table>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td valign=\"top\"><div class=\"div4p\">祭 小空五天白病劫車</div></td>\n");
      out.write("\t\t\t\t\t<td valign=\"top\"><div class=\"div4p\">改 人亡鬼狗虎符財關</div></td>\n");
      out.write("\t\t\t\t\t<td valign=\"top\">");
if( ((People)outprintPeopleList.get(tpc)).getPeople_gender()==1){
      out.write('男');
}else{ 
      out.write('女');
} 
      out.write("<div class=\"div3p\">");
