...
<table class="table_sytle" border="1">
	<tr valign="top">
		<%
		...
		<td >
			<table>
				<tr>
					<td valign="top"><div class="div4p">祭 小空五天白病劫車</div></td>
					<td valign="top"><div class="div4p">改 人亡鬼狗虎符財關</div></td>
					<td valign="top"><%if( ((People)outprintPeopleList.get(tpc)).getPeople_gender()==1){%>男<%}else{ %>女<%} %><div class="div3p"><%=((People)outprintPeopleList.get(tpc)).getPeople_name()%></div></td>
