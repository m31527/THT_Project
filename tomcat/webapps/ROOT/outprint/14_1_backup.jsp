...
<style type="text/css">
	...
	.table_sytle td{
		width:3.7cm;height: 9.5cm;background: white;
	}
	.div1{
		float: right;padding-right: 25px;font-size: 13pt;
	}
...
%>
<div style="page-break-after: always;margin-left: -10px;padding-left: 0;margin-top: 10px" >
<table class="table_sytle" >
	<tr valign="top">
		...
		%>
		<td >
			<div class="div1"><p class="div1p"><%=((People)outprintPeopleList.get(tpc)).getPeople_address()%></p></div>
			<div class="div2"><p class="div2p"><%=((People)outprintPeopleList.get(tpc)).getPeople_name()%><span style="color: white;visibility : hidden;">空白</span>大德</p></div>
		</td>
		<%}else{ %>
		<td >
