...
public final class Lauar
{
    ...
    private static int[] solarMonth = { 31, 28, 31, 30, 31, 30, 31, 31, 30,
            31,

            30, 31 };
    
    private static String[] Gan = { "甲", "乙", "丙", "丁", "戊", "己", "庚",
            "辛",

            "壬", "癸" };
    
    private static String[] Zhi = { "子", "醜", "寅", "卯", "辰", "巳", "午",
            "未",

            "申", "酉", "戌", "亥" };
    
    private static String[] Animals = { "鼠", "牛", "虎", "兔", "龍", "蛇", "馬",
            "羊",

            "猴", "雞", "狗", "豬" };
    
    private static int[] sTermInfo = { 0, 21208, 42467, 63836, 85337,
            107014,
    ...
    private static String[] nStr1 = { "日", "一", "二", "三", "四", "五", "六",
            "七",
    ...
    private static String[] yearName = { "零", "壹", "貳", "叁", "肆", "伍", "陸",
    ...
    private static void Lunar1(Date objDate)
    {
        ...
        cl.set(1900, 0, 31); // 1900-01-31是農曆1900年正月初一
        
        Date baseDate = cl.getTime();
        
        // 1900-01-31是農曆1900年正月初一
        
        int offset = (int) ((objDate.getTime() - baseDate.getTime()) / 86400000); // 天數(86400000=24*60*60*1000)
        
        // System.out.println(offset);
        
        dayCyl = offset + 40; // 1899-12-21是農曆1899年臘月甲子日
        
        monCyl = 14; // 1898-10-01是農曆甲子月
    ...
    public static String getLunar(String year, String month, String day)
    {
        ...
        s = "農曆" + "【" + Animals[sy] + "】" + cYear(getYear()) + "年" + " ";
        
        s += (getIsLeap() ? "閏" : "") + monthNong[getMonth()] + "月"
    ...
    public static String yearToChinese(int yyyy){
        String yy = String.valueOf(yyyy - 1911);//convert to 民國年
        // 民國100年取2位數年
        yy = yy.substring(yy.length()-2); // get last 2 chars
           return yy;
    }
    

    public static String getLunarSample(String year, String month, String day ,String type)
    {
        ...
        s ="【" + Animals[sy] + "】" + MyUtil.getNumToChinese(yearToChinese(getYear())) + "年" + " ";
    ...
    {
        System.out.println(getLunarSample("49", "8", "25",""));
    }
